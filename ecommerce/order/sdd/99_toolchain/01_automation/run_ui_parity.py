# -*- coding: utf-8 -*-
"""UI parity 게이트: order_list 화면을 스냅샷과 대조합니다.
...
from server.contexts.order import screens  # noqa: E402

SNAP = _ROOT / "sdd/04_verify/10_test/ui_parity/order_list.html"


def main():
    want = SNAP.read_text(encoding="utf-8").strip()
    try:
        got = screens.render("order_list").strip()
